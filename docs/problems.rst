...
``vnd.error`` and ``API-Problem``. In LaminasRest, I have provided support for
...
status code may be enough to begin. As such, LaminasRest assumes that if you
